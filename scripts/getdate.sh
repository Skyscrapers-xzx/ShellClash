...
setserver(){
	...
	if	[ -z "$num" ]; then 
		...
		release_url='https://fastly.jsdelivr.net/gh/Skyscrapers-xzx/ShellClash'
		saveserver
	elif [ "$num" = 2 ]; then
		release_url='https://raw.fastgit.org/Skyscrapers-xzx/ShellClash'
		saveserver
	elif [ "$num" = 3 ]; then
		update_url='https://raw.githubusercontent.com/Skyscrapers-xzx/ShellClash/master'
		release_url=''
		saveserver
	elif [ "$num" = 4 ]; then
		...
		update_url='https://raw.fastgit.org/Skyscrapers-xzx/ShellClash/master'
		release_url=''
		saveserver
	elif [ "$num" = 7 ]; then
		...
		$clashdir/start.sh webget /tmp/clashrelease https://raw.githubusercontent.com/Skyscrapers-xzx/ShellClash/master/bin/release_version echooff rediroff 2>/tmp/clashrelease
		...
		if [ -z "$num" -o "$num" = 0 ]; then
			...
			update_url="https://raw.githubusercontent.com/Skyscrapers-xzx/ShellClash/$release_version"
			saveserver
			release_url=''
		else
			echo -----------------------------------------------
